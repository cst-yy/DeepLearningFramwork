...
@Auth ： yangyu
@File ：functions_conv.py
@Motto：ABC(Always Be Coding)
"""

import numpy as np

from descalefed import as_variable, cuda
from descalefed.functions import Function
from descalefed.functions import linear
from descalefed.utils import pair, get_conv_outsize
...
def conv2d_simple(x, W, b=None, stride=1, pad=0):
    ...
    col = im2col_array(x, (KH, KW), stride, pad, to_matrix=True)
